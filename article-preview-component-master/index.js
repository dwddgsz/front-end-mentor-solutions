...
const changeToAuthor = function () {
    ...
    toggleSection.innerHTML = `
         ...
         <button class="share-button" id="button" onclick="changeToShare()"> <img src="./images/icon-share.svg" alt="share-button">
...
const changeForMobile = () => {
    ...
    changeToShare = () => {
       ...
       <button class="share-button" id="button" onclick="changeToAuthor()"> <img src="./images/icon-share.svg" alt="share-button">
       </button>`;
    }
}
